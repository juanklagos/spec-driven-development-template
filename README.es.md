...
<img src="https://img.shields.io/badge/version-v2.0.0-3b82f6?style=for-the-badge" alt="Versión">
<img src="https://img.shields.io/badge/licencia-MIT-8b5cf6?style=for-the-badge" alt="Licencia">
<a href="https://github.com/juanklagos/spec-driven-development-template/releases/tag/v2.0.0"><img src="https://img.shields.io/badge/release-latest-10b981?style=for-the-badge" alt="Último release"></a>
...
- **Dashboard visual:** corre `npm run mcp:http:start` y abre `http://127.0.0.1:3334/dashboard` para una vista ejecutiva de solo lectura del workspace (estado de la compuerta, tarjetas KPI, progreso por spec y avisos de dependencias) en tu idioma, sin compilar nada.
...
- Historial: [CHANGELOG.md](./CHANGELOG.md) · Último release: [v2.0.0](https://github.com/juanklagos/spec-driven-development-template/releases/tag/v2.0.0)
