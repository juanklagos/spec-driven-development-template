...
- [x] T7 (R7): la **tool MCP** del board expone `drift` (schema + integración en verde) → un agente lo ve. El **dashboard HTML** (`dashboard.ts`) muestra un badge ámbar `🔀 N` junto a los de gate/dependencias, con tooltip de los commits; ES/EN. Verificado en vivo sobre el workspace de demo.
