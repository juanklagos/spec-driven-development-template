...
- [ ] T5 (R5): paquete `@juanklagos/sdd` + README (EN/ES) + guía 51.
- [ ] T6 (R6): lanzadores de doble clic generados por `create-sdd-project`.
- [ ] T7 (R7): gate del `.mcpb` (empaquetado + verificación registrada en history).
- [ ] T8: verificación end-to-end en directorio limpio, validaciones y trazabilidad.
