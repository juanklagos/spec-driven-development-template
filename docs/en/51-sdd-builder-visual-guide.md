...
- Inside this template repository itself the builder is blocked on purpose (no target-project work in the template root). Always point `SDD_PROJECT_ROOT` at a real workspace.
