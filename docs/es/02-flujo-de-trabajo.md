...
- Español: **02-flujo-de-trabajo.md**
- English: [../en/02-workflow.md](../en/02-workflow.md)
...
| Paso | Acción | Qué queda escrito |
|---|---|---|
| 1 | Definir idea | `idea/IDEA_GENERAL.md` |
| 2 | Crear especificación | `specs/NNN-*/spec.md` |
| 3 | Planificar y dividir tareas | `plan.md` + `tasks.md` |
| 4 | Implementar | código, más las tareas marcadas en `tasks.md` |
| 5 | Registrar bitácora | `bitacora/diaria/AAAA-MM-DD.md` |
| 6 | Refinar | `history.md` de la spec |
