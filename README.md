...
<img src="https://img.shields.io/badge/version-v2.7.0-3b82f6?style=for-the-badge" alt="Version">
<img src="https://img.shields.io/badge/license-MIT-8b5cf6?style=for-the-badge" alt="License">
<a href="https://github.com/juanklagos/spec-driven-development-template/releases/tag/v2.7.0"><img src="https://img.shields.io/badge/release-latest-10b981?style=for-the-badge" alt="Latest release"></a>
...
- **Any agent (39 tools):** portable Agent Skill at [skills/sdd-workflow/SKILL.md](./skills/sdd-workflow/SKILL.md).
...
```yaml
- uses: juanklagos/spec-driven-development-template@v2.7.0
  with:
...
**Everything else:** the [full documentation index](./docs/README.md) organizes all 53 guides (EN/ES) by topic.
...
- Changelog: [CHANGELOG.md](./CHANGELOG.md) · Latest release: [v2.7.0](https://github.com/juanklagos/spec-driven-development-template/releases/tag/v2.7.0)
