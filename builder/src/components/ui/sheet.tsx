...
// El porqué largo está en button.tsx. Igual que en dialog.tsx, `SheetPortal`
// envuelve a cada hijo en `Presence` + `Portal asChild`: overlay y contenido
// reciben una ref del propio Radix (foco y scroll-lock). Root y Portal no pintan
// DOM: no llevan ref.
